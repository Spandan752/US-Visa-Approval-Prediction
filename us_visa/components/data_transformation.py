...
from us_visa.utlis.main_utils import save_object, save_numpy_array_data, read_yaml_file, drop_columns
...
class DataTransformation:
    ...
    def get_data_transformer_object(self) -> Pipeline:
        logging.info("Entered into the get_data_transformer_object method of DataTransformation class")
        try:
            ...
            logging.info("Exited the data_transformer_object from ColumnTransformer class")
            return preprocessor
        except Exception as e:
