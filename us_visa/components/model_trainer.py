...
from us_visa.utlis.main_utils import load_numpy_array_data, read_yaml_file, load_object, save_object
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, ) -> ModelTrainerArtifact:
        logging.info("Entered the initiate_model_trainer method of ModelTrainer classs")
        try:
            train_arr = load_numpy_array_data(file_path=self.data_tranformation_artifact.transformed_train_file_path)
            ...
            preprocessing_obj = load_object(file_path=self.data_tranformation_artifact.transformed_object_file_path)

            if best_model_detail.best_score < self.model_trainer_config.expected_accuracy:
                logging.info("No best model found with accuracy more than base score")
                raise Exception("No best model found with accuracy more than base score")
